...
describe('CartProductService', () => {
  ...
  it('should return error in exception verifyProductInCart', async() => {
    ...
    expect(service.verifyProductInCart(productMock.id, cartMock.id)).rejects.toThrow(Error)
  })

  it('should return error in exception insertProductInCart', async() => {
    jest
    .spyOn(productService, 'findProductById').mockRejectedValue(new NotFoundException())
  ...
  it('should return cart product if not exist cart', async() => {
    jest
    .spyOn(cartProductRepository, 'findOne').mockResolvedValue(undefined)
...
//Test in the function updateProductCart
